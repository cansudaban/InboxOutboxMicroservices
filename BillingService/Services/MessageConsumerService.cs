    ...
    public class MessageConsumerService : BackgroundService
    {
        ...
        public MessageConsumerService(IServiceScopeFactory scopeFactory, ILogger<MessageConsumerService> logger)
        {
            ...
            try 
            {
                ...
                _deadLetterQueueName = "dead_letter_queue_billing";
                ...
                _queueName = "billing_service_queue";
                _channel.QueueDeclare(
                    queue: _queueName, 
                    durable: true, 
                    exclusive: false, 
        ...
        {
            _logger.LogInformation("Billing MessageConsumerService started listening");
            ...
            consumer.Received += async (model, ea) =>
            {
                ...
                try
                {
                    ...
                    await _retryPolicy.ExecuteAsync(async () => 
                    {
                        ...
                        {
                            await GenerateInvoice(orderCreatedEvent, dbContext);
        ...
        private async Task GenerateInvoice(OrderCreatedEventDto orderEvent, BillingDbContext dbContext)
        {
            // Check if invoice already exists for this order
            var existingInvoice = await dbContext.Invoices
                .FirstOrDefaultAsync(i => i.OrderId == orderEvent.OrderId);
            
            if (existingInvoice != null)
            {
                _logger.LogInformation($"Invoice for order {orderEvent.OrderId} already exists. Skipping.");
                return;
            }
            ...
            var invoice = new Invoice
            {
                ...
                CreatedAt = DateTime.UtcNow,
                Items = orderEvent.Items.Select(item => new InvoiceItem
                {
            ...
            _logger.LogInformation($"Generated invoice for order {orderEvent.OrderId}");
        }
